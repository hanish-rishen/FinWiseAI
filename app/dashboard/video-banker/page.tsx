        ...
        >
          ...
          <div className="flex-1 relative bg-black rounded-none lg:rounded-xl overflow-hidden m-0 lg:m-2 mt-0">
            ...
            >
              ...
              <div className="absolute top-4 right-4 w-32 md:w-48 aspect-video rounded-lg overflow-hidden border-2 border-white shadow-xl">
                {cameraEnabled ? (
            ...
            <Card className="h-[calc(100vh-65px)] border-0 lg:border m-0 lg:mx-2 lg:my-2 rounded-none lg:rounded-xl shadow-none lg:shadow overflow-hidden">
              <CardContent className="p-0 h-full flex flex-col">
                ...
                <Tabs defaultValue="chat" className="flex-1 flex flex-col">
                  ...
                  <TabsContent
                    value="chat"
                    className="flex-1 flex flex-col m-0 data-[state=active]:border-0 overflow-hidden"
                  >
                    {/* Chat messages */}
                  ...
                  <TabsContent
                    value="documents"
                    className="flex-1 m-0 data-[state=active]:border-0 overflow-auto"
                  >
